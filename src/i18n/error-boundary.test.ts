...
const zh = JSON.parse(fs.readFileSync(path.join(ROOT, "messages/zh.json"), "utf8")) as Messages;
const en = JSON.parse(fs.readFileSync(path.join(ROOT, "messages/en.json"), "utf8")) as Messages;
