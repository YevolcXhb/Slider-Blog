...
function CategoryBar({ categories, totalPosts, currentPostCategory }: CategoryBarProps) {
  ...
  const isHome =
    pathWithoutLocale !== null && (pathWithoutLocale === "" || pathWithoutLocale === "/");
  ...
  useEffect(() => {
    ...
    function getCategoryBarState(currentUrl: URL) {
      ...
      const isHome =
        normalizedPathname === homePath || normalizedPathname === "" || normalizedPathname === "/";
    ...
    function setActiveCategory(currentUrl: URL) {
      ...
      if (isHome) {
        bar
          .querySelector<HTMLAnchorElement>('.category-pill[data-category-name=""]')
  ...
  return (
    <div
      ref={barRef}
      className="card-base category-bar onload-animation p-3"
      id="category-bar"
      data-home-path="/"
    ...
    >
      <div className="category-bar-inner flex gap-2">
        <Link
          href="/"
          className="category-pill flex shrink-0 items-center justify-center rounded-full px-3 py-1.5 text-sm transition-colors duration-150 ease-out"
          data-category-name=""
        ...
        <Link
          href="/blog"
          className="category-pill flex shrink-0 items-center justify-center rounded-full px-4 py-1.5 text-sm whitespace-nowrap transition-colors duration-150 ease-out"
            ...
            {categories.map((cat) => {
              ...
              return (
                <Link
                  ...
                  className="category-pill flex items-center justify-center rounded-full px-4 py-1.5 text-sm whitespace-nowrap transition-colors duration-150 ease-out"
        ...
        <div className="category-divider more-divider shrink-0" aria-hidden="true" />

        <Link
          href="/categories"
          className="category-pill flex shrink-0 items-center justify-center gap-1 rounded-full px-3 py-1.5 text-sm transition-colors duration-150 ease-out"
