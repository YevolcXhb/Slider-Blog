            ...
            <>
              {items.map((item) => (
                <a
                  ...
                  title={item.text}
                >
                  <div className={cn("toc-badge", item.badgeKind === "index" && "toc-badge-index")}>
                  ...
                  <div
                    className={cn(
                      "toc-label",
                      item.labelPrimary ? "toc-label-primary" : "toc-label-secondary",
                    )}
                  >
                    {item.text}
                  </div>
              ...
              <div id={INDICATOR_ID} className="toc-active-indicator" style={{ opacity: 0 }} />
            </>
          ) : !encrypted && items.length === 0 ? (
