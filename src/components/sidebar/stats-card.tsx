...
function StatsCard({ stats, lastPostDate }: StatsCardProps) {
  ...
  const statItems = [
    ...
    },
    {
      ...
      value:
        lastUpdateDays === null ? "-" : lastUpdateDays === 0 ? t("siteStatsToday") : lastUpdateDays,
      suffix:
        lastUpdateDays && lastUpdateDays > 0 ? t("siteStatsDaysAgo", { days: "" }).trim() : "",
    },
  ];
          ...
          return (
            <div key={stat.label} className="stat-item">
              ...
              <div className="stat-item-right">
                ...
                {stat.suffix && <span className="stat-item-suffix">{stat.suffix}</span>}
              </div>
            </div>
          );
        })}
